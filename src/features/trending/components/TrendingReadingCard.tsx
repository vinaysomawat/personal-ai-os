  ...
  return (
    <div className="bg-surface-1 border border-surface-3 rounded-xl p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h2 className="text-sm font-semibold text-slate-300 uppercase tracking-wider">Today&apos;s Trending Read</h2>
      </div>

      {!reading ? (
        <p className="text-sm text-slate-600 text-center py-4">No matching frontend/AI story on the front page today — check back tomorrow.</p>
      ) : (
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-600 mt-0.5">Hacker News{reading.points ? ` · ${reading.points} points` : ''}</p>
          </div>
